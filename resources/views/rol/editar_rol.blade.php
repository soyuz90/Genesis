				...
				<div class="panel-body">
					<div>
						<form class="form-horizontal" method="POST" action="/roles/update/{{$rol->id}}">							
							...
							<div class="form-group">
								<label class="col-md-4 control-label" for="textinput">Nivel del Rol:</label>  
								<div class="col-md-3">
									<input id="textinput" name="nombres" type="text" placeholder="*Nombre" value="{{$rol->level}}" class="form-control input-md" required>
								</div>
							</div>
							<div class="">
